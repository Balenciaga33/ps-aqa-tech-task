...
test.describe('UI Notes', () => {
  test('create, edit and delete note from UI', async ({ app, registeredUser }) => {
  ...
  test('cancel delete keeps the note', async ({ app, notesClient, registeredUser }) => {
  ...
  test('search filters notes in the list', async ({ app, page, notesClient, registeredUser }) => {
  ...
  test('sort by title A-Z updates the list order', async ({
    app,
    page,
    notesClient,
    registeredUser,
